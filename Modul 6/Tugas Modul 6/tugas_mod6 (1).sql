...
CREATE TABLE `faculty_course` (
  `ID_FacultyCourse` int(5) NOT NULL,
  `ID_Course` int(5) NOT NULL,
  `ID_Faculty` int(5) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `faculty_course` (`ID_FacultyCourse`, `ID_Course`, `ID_Faculty`) VALUES
(6001, 2001, 1001),
(6002, 2002, 1002);
...
INSERT INTO `studies` (`ID_Studies`, `ID_Student`, `ID_Course`) VALUES
(7001, 1, 2001),
(7002, 2, 2002);
...
INSERT INTO `works` (`ID_Works`, `ID_Faculty`, `ID_Project`) VALUES
(8001, 1001, 5001),
(8002, 1002, 5002);
...
ALTER TABLE `faculty_course`
  ADD PRIMARY KEY (`ID_FacultyCourse`),
  ADD KEY `ID_Course` (`ID_Course`),
  ADD KEY `ID_Faculty` (`ID_Faculty`);
...
--
ALTER TABLE `faculty_course`
  ADD CONSTRAINT `faculty_course_ibfk_1` FOREIGN KEY (`ID_Course`) REFERENCES `course` (`ID_Course`),
  ADD CONSTRAINT `faculty_course_ibfk_2` FOREIGN KEY (`ID_Faculty`) REFERENCES `faculty` (`ID_Faculty`);
...
--
ALTER TABLE `studies`
  ADD CONSTRAINT `studies_ibfk_1` FOREIGN KEY (`ID_Student`) REFERENCES `student` (`ID_Student`),
  ADD CONSTRAINT `studies_ibfk_2` FOREIGN KEY (`ID_Course`) REFERENCES `course` (`ID_Course`);

--
-- Constraints for table `works`
--
ALTER TABLE `works`
  ADD CONSTRAINT `works_ibfk_1` FOREIGN KEY (`ID_Faculty`) REFERENCES `faculty` (`ID_Faculty`),
  ADD CONSTRAINT `works_ibfk_2` FOREIGN KEY (`ID_Project`) REFERENCES `research_project` (`ID_Project`);
COMMIT;
